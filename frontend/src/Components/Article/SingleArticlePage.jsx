...
useEffect( () => {
  const fetchArticle = async() => {
    try{
      const response = await axios.get(`${ARTICLE_SERVER_NODE_BASE_URL}article/${id}`)
      const {title, name, category, body, is_banned,createdAt, is_premium} = response.data
      setArticle({ title, name, category, body, createdAt, is_banned, is_premium });
