...
export {Whatsapp, SaveFill,Flag,X, CardChecklist, PersonFill,PersonCircle, ArrowLeftCircleFill, BoxArrowLeft,HandThumbsUpFill, PersonLinesFill,TrashFill, PencilSquare, ShareFill, HandThumbsUp, ChatFill } from 'react-bootstrap-icons';
