  ...
  return (
    <div className="admin_sidebar">
      <ul className="menu">
        <li
          className={`menu-item ${
            location.pathname === "/admin" ? "admin_sidebar_active" : ""
          }`}
        >
        ...
        <li
          className={`menu-item ${
            location.pathname === "/admin/users" ? "admin_sidebar_active" : ""
          }`}
        >
        ...
        >
          <Link
            className="admin_sidebar_icon_with_label"
            to="/admin/categories"
          >
            <span className="icon">
              <BookmarkStarFill />
        ...
        <li
          className={`menu-item ${
            location.pathname === "/admin/interests"
              ? "admin_sidebar_active"
              : ""
          }`}
        >
